...
/**
 * Dự án phụ — nâng cấp toàn diện: khung sườn module Nhập doanh số — CHƯA có
...
export function SalesEntryClient() {
  useSetPageTitle("Nhập doanh số", "Nghiệp vụ nhập doanh số sẽ sớm được ra mắt.");

  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-2 text-center">
      <p className="text-lg font-medium text-slate-700">Nghiệp vụ nhập doanh số sẽ sớm được ra mắt</p>
